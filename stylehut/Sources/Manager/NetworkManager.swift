...
class NetworkManager {
    ...
    class func wishListProduct(product_id: Int) async -> Bool {
        guard let url = URL(string: k.urls.wishList) else {
            fatalError("Invalid URL")
        }
    ...
    class func getBrand(urlSting: String) async -> BrandData? {
          guard let url = URL(string: urlSting) else {
              print("Invalid URL")
              return nil
          }
    ...
    class func getWishListedProduct(urlSting: String) async -> wishlistData? {
          guard let url = URL(string: urlSting) else {
              print("Invalid URL")
              return nil
          }
